...
class Wsaa {
    ...
    const CERT_HOMOLOGACION = "/20463482056/key/homologacion/certificado.pem"; # Certificado X.509 otorgado por AFIP
    const PRIVATEKEY_HOMOLOGACION = "/20463482056/key/homologacion/privada"; # Clave privada de la PC
